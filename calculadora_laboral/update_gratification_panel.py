...
with open('lib/presentation/widgets/inputs/gratification_inputs_panel.dart', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('lib/presentation/widgets/inputs/gratification_inputs_panel.dart', 'w', encoding='utf-8') as f:
    f.write(content)
